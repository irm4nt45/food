...
import {ProgressBarService} from '../../../shared/services/progress-bar.service';
 ...
 export class API3Interceptor implements HttpInterceptor { 
   ...
   intercept(
     ...
     const cloneReq = req.clone({ setHeaders: {"Access-Control-Allow-Headers": "Content-Type, Access-Control-Allow-Headers, Authorization, X-Requested-With"}
